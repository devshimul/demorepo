...
if (isset($_GET['id']) && isset($_GET['code'])) {
    ...
    $stmt = $con->prepare("SELECT * FROM users WHERE user_id=:uID AND token_code=:code LIMIT 1");
    ...
    if ($stmt->rowCount() == 1) {
        if (isset($_POST['btn-reset-pass'])) {
            ...
            if ($cpass !== $pass) {
                ...
                $stmt = $con->query("UPDATE users SET user_password='$password' WHERE user_id='$uid'");
