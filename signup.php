...
if (isset($_POST['create'])) {
    ...
    $checkMail = $con->query("SELECT user_email FROM users WHERE user_email = '$email'");

    $count = $checkMail->rowCount();
    if ($count == 0) {
        $query = "INSERT INTO users(user_name, 	user_email, user_password, token_code) VALUES('$name', '$email', '$encpwd', '$code')";
        ...
        if ($captcha != $_SESSION['captcha_code']) {
            ...
            $message = "					
						...
						<br /><br />
						<a href='http://localhost/Project%20With%20Core%20PHP/verify.php?id=$id&code=$code'>Click HERE to Activate :)</a>
						<br /><br />
						Thanks,";
            ...
            $mail->Username = 'sbshimul00@gmail.com';
            $mail->Password = 'SshimulB12345';
            $mail->SetFrom('sbshimul00@gmail.com', 'Coders builder');
            $mail->AddReplyTo("sbshimul00@gmail.com", "Coders builder");
        ...
        $msg = "Sorry this email already taken !!! &#128531;";
    }
...
<body>
    ...
    <div class="container">
        <div class="error text-center"  id="result">
            <?php if (isset($msg)) {
        ...
        <div class="row justify-content-center">
            <div class="col-6 col-md-4 bg mt-3">
                <h1 class="display-2 heading text-center">Sign Up</h1>
                <hr>
        ...
        $("#name").blur(function() {
            ...
            if (name.length > 3) {
                ...
                $.ajax({
                    ...
                    data: {
                        name: name
                    }, //The serialize() method creates a URL encoded text string by serializing form values. The serialized values can be used in the URL query string when making an AJAX request.
