...
if (isset($_POST['login'])) {
    ...
    $query = $con->query("SELECT user_id, user_email, user_password, user_status, role, status FROM users WHERE user_email='$email'");
    ...
    if ($row['user_status'] === 'N') {
        ...
        $msg = "your Account Is'n activated Please contact with admin  !";
        header("Location: index.php?error=$msg");
