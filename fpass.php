...
if (isset($_POST['btn-submit'])) {
    ...
    $stmt = $con->query("SELECT user_id FROM users WHERE user_email = '$email'");
    ...
    if ($stmt->rowCount() == 1) {
        ...
        $stmt = $con->query("UPDATE users SET token_code='$code' WHERE user_email='$email'");
        $message = "
				   Hello , $email
				   <br /><br />
				   ...
				   <br /><br />
				   <a href='http://localhost/Project%20With%20Core%20PHP/reset.php?id=$id&code=$code'>click here to reset your password</a>
				   <br /><br />
				   thank you :)
                   ";
